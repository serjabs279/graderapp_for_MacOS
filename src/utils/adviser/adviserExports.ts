...
export function exportAdviserSubjectRecordPDF(
  ...
  doc.save(`SubjectRecord_${subjectData.subjectName}_${adviserClass.section}.pdf`);
}
...
export function exportAdviserSubjectRecordExcel(
  ...
  XLSX.writeFile(wb, `SubjectRecord_${subjectData.subjectName}_${adviserClass.section}.xlsx`);
}
